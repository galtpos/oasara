...
interface PledgeBlockProps {
  variant?: 'full' | 'compact';
}

const PledgeBlock: React.FC<PledgeBlockProps> = ({ variant = 'full' }) => {
  ...
  const pledges = [
    ...
    {
      id: 'cancel_insurance',
      title: 'Exit Insurance This Fall',
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <div className="flex justify-center gap-6 md:gap-12 mb-4 flex-wrap">
              ...
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-gold-400">{pledgeCounts.medical_trust}</div>
                <div className="text-sm text-slate-400 uppercase tracking-wide">Forming Trust</div>
              </div>
              <div className="text-center">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}>
            ...
            <div className="space-y-2 text-xl md:text-2xl text-white font-display leading-relaxed">
              ...
              <p className="text-gold-400">TO EXIT INSURANCE THIS FALL</p>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="hidden md:inline text-slate-400 hover:text-white text-sm underline"
                      >
                  ...
                  >
                    ...
                    {pledge.id === 'cancel_insurance' && pledge.details && (
                      <div className="space-y-6">
                        ...
                        <div>
                          <h4 className="text-gold-400 font-semibold mb-3">How to Exit</h4>
            ...
            >
              ...
              <div className="mb-8">
                ...
                <div className="flex justify-center gap-3 flex-wrap">
                  <a
                    href={`https://twitter.com/intent/tweet?text=${encodeURIComponent("I just pledged to take control of my healthcare. Join the revolution:")}&url=${encodeURIComponent("https://oasara.com/")}&hashtags=HealthcareSovereignty,MedicalFreedom`}
                    target="_blank"
                  ...
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://oasara.com/")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      navigator.clipboard.writeText("https://oasara.com/");
                      alert("Link copied!");
                    }}
