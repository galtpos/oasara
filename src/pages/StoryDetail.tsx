                ...
                <div>
                  <div className="text-sm font-medium text-ocean-700">
                    Originally shared on {
                      story.source_platform === 'twitter' ? 'X (Twitter)' :
                      story.source_platform === 'youtube' ? 'YouTube' :
                      story.source_platform === 'reddit' ? 'Reddit' :
                      story.source_platform === 'gofundme' ? 'GoFundMe' :
                      story.source_platform === 'news' ? 'News' :
                      story.source_platform || 'public source'
                    }
                  </div>
